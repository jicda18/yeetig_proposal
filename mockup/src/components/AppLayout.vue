  ...
  <div class="min-h-screen bg-slate-50">
    ...
    >
      ...
      <div
        ...
        :class="sidebarCollapsed ? 'px-4' : 'px-6'"
      >
        <div class="flex items-center gap-2.5 overflow-hidden">
          <div
            class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 shadow-lg shadow-indigo-500/30"
          >
      ...
      <div class="px-3 py-2">
        ...
        >
          ...
          <PanelLeftOpen
            ...
            class="h-5 w-5 shrink-0 transition-transform group-hover:scale-110"
          />
          <span v-if="!sidebarCollapsed" class="transition-opacity duration-200"
            >Collapse</span
          >
        </button>
      </div>
      ...
      <div class="border-t border-slate-800 p-3">
        ...
        >
          ...
          <LogOut
            v-if="!sidebarCollapsed"
            class="h-4 w-4 text-slate-500 group-hover:text-slate-300 shrink-0 transition-colors"
          />
        </div>
      </div>
    </aside>
      ...
      >
        ...
        <div class="ml-auto flex items-center gap-2">
          ...
          >
            <Bell class="h-5 w-5" />
            <span
              class="absolute right-2.5 top-2.5 h-2 w-2 rounded-full bg-fuchsia-500 ring-2 ring-white"
            />
          </button>
